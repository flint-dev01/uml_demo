...
const PageTest = () => {
    ...
    const handleUsecaseButtonClick = async () => {
        setLoading(true);
        try {
            const response = await axios.post('https://grotesque-marsiella-flint-dev01-4287a2bf.koyeb.app/uml/generate-usecase', {
                "srs_text": srsText
            });
    ...
    const handleSequenceButtonClick = async () => {
        setLoading(true);
        try {
            const response = await axios.post('https://grotesque-marsiella-flint-dev01-4287a2bf.koyeb.app/uml/generate-sequence', {
    ...
    const handleActivityButtonClick = async () => {
        setLoading(true);
        try {
            const response = await axios.post('https://grotesque-marsiella-flint-dev01-4287a2bf.koyeb.app/uml/generate-activity', {
                "usecase_code": usecaseCode,
                "actors": actors,
                "srs_text": srsText
            });
